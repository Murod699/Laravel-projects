          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="{{route('admin.feedbacks.show', $message->id)}}">
                  ...
                  <div class="font-weight-bold">
                    ...
                    <div class="small text-gray-500">{{$message->name}} . {{$message->created_at->format('H:i, d/m/y')}}</div>
                  </div>
                </a>              
                @endforeach
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Devcenter.uz 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Agar tizimdan chiqmoqchi bolsangiz "Ha" tugmasini bosing.</div>
